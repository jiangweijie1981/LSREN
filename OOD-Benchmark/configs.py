...
class Config():
    def __init__(self):
        ...
        self.parser.add_argument('--in_dataset', type=str, default='cifar100',choices=('cifar10', 'cifar100'))
        self.parser.add_argument('--out_dataset', default="All", type=str,\
            choices=('Imagenet', 'Imagenet_resize', 'LSUN', 'LSUN_resize', 'iSUN', 'Gaussian', 'Uniform','SVHN','All','cifar10','cifar100'))
        ...
        self.parser.add_argument('--f1_thred_coef', type=float, default=0.999)
        ...
        self.parser.add_argument('--cur_temperature', default=1000, type=float,help='temperature scaling')
